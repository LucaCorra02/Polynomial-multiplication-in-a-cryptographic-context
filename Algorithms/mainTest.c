...
static MunitResult test_diff_poly_double_img_neg(const MunitParameter params[], void* user_data) {
    (void) params;
    (void) user_data;
    ...
    f9_element expected[] = {
        get_f9_element(1,0), get_f9_element(1,1), get_f9_element(1,2), get_f9_element(2,0)
    };

    f9_element ris[4] = {0,0,0,0};
    int dim_p1 = 4;
    int dim_p2 = 3;
    diff_poly_double_img_neg(dim_p1, dim_p2, p1, p2, ris);
    for (int j = 0; j < dim_p1; ++j) {
        munit_assert_int(ris[j], ==, expected[j]);
    }
    return MUNIT_OK;
...
static MunitResult test_diff_poly_neg_img_f3(const MunitParameter params[], void* user_data) {
    (void) params;
    (void) user_data;

    int p1[] = {1, 1, 2, 0, 1, 1}; //2  2  1  0 2 2
    int p2[] = {1, 2, 1, 0, 2};    //2i 1i 2i 0 1i
    f9_element expected[] = {
        get_f9_element(2,2), get_f9_element(1,2), get_f9_element(2,1),
        get_f9_element(0,0), get_f9_element(1,2), get_f9_element(0,2)
    };

    f9_element ris [6] = {0, 0, 0, 0, 0, 0};
    int dim_p1 = 6;
    int dim_p2 = 5;
    diff_poly_neg_img_f3(dim_p1, dim_p2, p1, p2, ris);
    for (int j = 0; j < dim_p1; ++j) {
        munit_assert_int(ris[j], ==, expected[j]);
    }
    return MUNIT_OK;
...
static MunitResult test_diff_poly_pos_img_f3(const MunitParameter params[], void* user_data) {
    (void) params;
    (void) user_data;

    int p1[] = {1, 1, 2, 0, 1, 1}; //2  2  1  0 2 2
    int p2[] = {1, 2, 1, 0, 2};    //1i 2i 1i 0 2i
    f9_element expected[] = {
        get_f9_element(1,2), get_f9_element(2,2), get_f9_element(1,1),
        get_f9_element(0,0), get_f9_element(2,2), get_f9_element(0,2)
    };

    f9_element ris [6] = {0, 0, 0, 0, 0, 0};
    int dim_p1 = 6;
    int dim_p2 = 5;
    diff_poly_pos_img_f3(dim_p1, dim_p2, p1, p2, ris);
    for (int j = 0; j < dim_p1; ++j) {
        munit_assert_int(ris[j], ==, expected[j]);
    }
    return MUNIT_OK;
...
static MunitResult test_diff_poly_img_img_f3(const MunitParameter params[], void* user_data) {
    (void) params;
    (void) user_data;

    f9_element p1[] = {get_f9_element(0, 0), get_f9_element(1, 1), get_f9_element(1, 2), get_f9_element(0, 1)};
    f9_element p2[] = {get_f9_element(1, 1), get_f9_element(2, 2), get_f9_element(1, 2), get_f9_element(1, 0)};
    int expected[] = {2, 2, 0, 2};
    int ris [4] = {0, 0, 0, 0};
    int dim_p1 = 4;
    int dim_p2 = 4;
    diff_poly_img_img_f3(dim_p1, dim_p2, p1, p2, ris);
    for (int j = 0; j < dim_p1; ++j) {
        munit_assert_int(ris[j], ==, expected[j]);
    }
    return MUNIT_OK;
...
static MunitResult test_diff_poly_real_img_f3(const MunitParameter params[], void* user_data) {
    (void) params;
    (void) user_data;

    f9_element p1[] = {get_f9_element(0, 1), get_f9_element(1, 1), get_f9_element(1, 2), get_f9_element(0, 1)};
    f9_element p2[] = {get_f9_element(1, 2), get_f9_element(2, 1), get_f9_element(1, 1), get_f9_element(1, 0)};
    int expected[] = {0, 2, 1, 0};
    int ris [4] = {0, 0, 0, 0};
    int dim_p1 = 4;
    int dim_p2 = 4;
    diff_poly_real_img_f3(dim_p1, dim_p2, p1, p2, ris);
    for (int j = 0; j < dim_p1; ++j) {
        munit_assert_int(ris[j], ==, expected[j]);
    }
    return MUNIT_OK;
...
static MunitResult test_sum_poly_double_img_f3(const MunitParameter params[], void* user_data) {
    (void) params;
    (void) user_data;
    ...
    int dim_p1 = 4;
    int dim_p2 = 4;
    sum_poly_double_img_f3(dim_p1, dim_p2, p1, p2, ris);
    for (int j = 0; j < dim_p1; ++j) {
        munit_assert_int(ris[j], ==, expected[j]);
    }
    return MUNIT_OK;
...
static MunitResult test_diff_poly_double_real_f3(const MunitParameter params[], void* user_data) {
    (void) params;
    (void) user_data;
    ...
    int dim_p1 = 4;
    int dim_p2 = 4;
    diff_poly_double_real_f3(dim_p1, dim_p2, p1, p2, ris);
    for (int j = 0; j < dim_p1; ++j) {
        munit_assert_int(ris[j], ==, expected[j]);
    }
    return MUNIT_OK;
...
static MunitTest tests_f3[] = {
    ...
    { "/test_diff_poly_neg_img_f3", test_diff_poly_neg_img_f3, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
    { "/test_diff_poly_pos_img_f3", test_diff_poly_pos_img_f3, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
    { "/test_diff_poly_img_img_f3", test_diff_poly_img_img_f3, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
    {"/test_diff_poly_real_img_f3", test_diff_poly_real_img_f3, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
    {"/test_sum_poly_double_img_f3", test_sum_poly_double_img_f3, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
    {"/test_diff_poly_double_real_f3", test_diff_poly_double_real_f3, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
    { NULL, NULL, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL }
};
...
int main(int argc, char* argv[]) {
    ...
    while (fgets(buffer, BUFFERSIZE , stdin)){
        ...
        int* ris = split_4_v1_f3(NUM_OPERANDS, p1,p2);
