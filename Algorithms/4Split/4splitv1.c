...
f9_element* split_4_f9(int m, f9_element* p1, f9_element* p2){
    ...
    P1 = schoolbook_f9(n, S3, S3_b);
    P2 = schoolbook_f9(n, S6, S6_b);
    P3 = schoolbook_f9(n, S7, S7_b);
    P4 = schoolbook_f9(n, S9, S9_b);
    P5 = schoolbook_f9(n, S10, S10_b);
