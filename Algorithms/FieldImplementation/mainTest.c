...
static MunitResult test_f9_mul_img_neg(const MunitParameter params[], void* user_data) {
    (void) params;
    (void) user_data;

    f9_element input[] = {get_f9_element(0,0),get_f9_element(0,1),get_f9_element(0,2),get_f9_element(1,0),get_f9_element(1,1),get_f9_element(1,2),get_f9_element(2,0),get_f9_element(2,1),get_f9_element(2,2)};
    f9_element expected[] = {get_f9_element(0,0),get_f9_element(2,0),get_f9_element(1,0),get_f9_element(0,1),get_f9_element(2,1),get_f9_element(1,1),get_f9_element(0,2),get_f9_element(2,2),get_f9_element(1,2)};
    int dim = 9;
    for (int i = 0; i < dim; ++i){
        f9_element ris = f9_prod_img_neg(input[i]);
        munit_assert_int(ris, ==, expected[i]);
    }
    return MUNIT_OK;
}
...
static MunitTest tests[] = {
    ...
    { "/test_f9_mul_img_neg", test_f9_mul_img_neg, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
